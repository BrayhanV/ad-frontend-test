...
export const MlProductImage = ({ src, alt, isNew, newLabel, variant }: MlProductImageProps) => {
  return (
    <div className={`relative ${MlProductImageClasses[variant ?? MlProductImageVariant.CATALOG]}`}>
      {isNew && (
